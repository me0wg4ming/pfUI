...
function pfUI:LoadConfig()
  ...
  for _, unit in pairs(ufs) do
    ...
    pfUI:UpdateConfig("unitframes", unit,      "txthpshortnamelen","3")
    ...
    pfUI:UpdateConfig("unitframes", unit,      "txthpleftsizedelta",    "0")
    ...
    pfUI:UpdateConfig("unitframes", unit,      "txthpcentersizedelta",    "0")
    ...
    pfUI:UpdateConfig("unitframes", unit,      "txthprightsizedelta",    "0")
