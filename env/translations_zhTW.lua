pfUI_translation["zhTW"] = {
  ...
  ["Center"] = "居中",
  ["Center Text"] = "中間文字",
  ["Center Text Font Size Delta"] = nil,
  ...
  ["Overwrite Border Color With Combat State"] = "根據戰鬥狀態覆蓋邊框顏色",
  ["Overwrite Colors"] = nil,
  ["Overwrite Fonts"] = nil,
  ["Overwrite Health Color With Combat State"] = "根據戰鬥狀態覆蓋生命值顏色",
  ["Overwrite If Unit Is Attacking No One"] = "如果单位沒有攻擊目標則覆蓋",
  ...
  ["Right Text"] = "右側文字",
  ["Right Text Font Size Delta"] = nil,
  ...
  ["Unit Is Attacking No One Color"] = "单位沒有攻擊目標的顏色",
  ["Unit Is Attacking Off-Tank Color"] = nil,
  ["Unit Is Attacking Others Color"] = "单位正在攻擊其它单位的顏色",
  ["Unit Is Attacking You Color"] = "单位正在攻擊你的顏色",
  ["Unit Is Casting Color"] = "单位正在施法的顏色",
  ["Unit String"] = "等級和名字",
